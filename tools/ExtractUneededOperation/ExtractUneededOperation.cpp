...
/// Load the memory dependency infomation generated by extract-memory-dependency tool.
///
/// \param mem_dependencies_file_name - path to the generated file of extract-memory-dependency tool.
/// \param mem_dependencies - the memory dependencies extracted by extract-memory-dependency tool.
///
...
/// A simple DFS function for figuring out which basic block can be reached from a basic block.
...
/// Prepare the post dominator infomation from the calling graph of basic blocks.
///
...
/// \param needed - for recording all the needed but not yet proccessed dynamic instructions
/// \param mem_depended - the memory dependencies extracted by extract-memory-dependency tool.
///
